...
public class ClientDemoService : ITransientDependency
{
    ...
    public ClientDemoService(
        ICartAppService sampleAppService,
        IIdentityModelAuthenticationService authenticationService,
        IConfiguration configuration)
    {
        _cartAppService = sampleAppService;
    ...
    private async Task TestWithDynamicProxiesAsync()
    {
        ...
        //result = await _cartAppService.GetAuthorizedAsync();
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:ShoppingCart:BaseUrl"] +
                      "api/ShoppingCart/sample/authorized";
