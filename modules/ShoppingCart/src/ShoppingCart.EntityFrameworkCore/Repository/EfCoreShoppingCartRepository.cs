...
{
    public class EfCoreShoppingCartRepository : EfCoreRepository<ShoppingCartDbContext, Cart, Guid>
        , IShoppingCartRepository
    {
        private readonly IDbContextProvider<ShoppingCartDbContext> _dbContextProvider;
        private readonly ICurrentUser _currentUser;

        public EfCoreShoppingCartRepository(IDbContextProvider<ShoppingCartDbContext> dbContextProvider, ICurrentUser currentUser) : base(
            dbContextProvider)
        {
