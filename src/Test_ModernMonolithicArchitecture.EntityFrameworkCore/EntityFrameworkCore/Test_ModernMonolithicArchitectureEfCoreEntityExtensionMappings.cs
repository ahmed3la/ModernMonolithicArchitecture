...
public static class Test_ModernMonolithicArchitectureEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE Test_ModernMonolithicArchitectureModuleExtensionConfigurator CLASS (in the Domain.Shared project)
