    ...
    //ITenantManagementDbContext
{
    ...
    public Test_ModernMonolithicArchitectureDbContext(DbContextOptions<Test_ModernMonolithicArchitectureDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(Test_ModernMonolithicArchitectureConsts.DbTablePrefix + "YourEntities", Test_ModernMonolithicArchitectureConsts.DbSchema);
